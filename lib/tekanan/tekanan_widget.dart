...
import 'tekanan_model.dart';
export 'tekanan_model.dart';

class TekananWidget extends StatefulWidget {
  const TekananWidget({Key? key}) : super(key: key);

  @override
  _TekananWidgetState createState() => _TekananWidgetState();
}

class _TekananWidgetState extends State<TekananWidget> {
  late TekananModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TekananModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<TelkesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final tekananTelkesRecord = snapshot.data!;
                          ...
                          'Listdarah': FieldValue.arrayUnion([
                            getListdarahFirestoreData(
                              createListdarahStruct(
                                ...
                                sistole: floatingActionButtonTelkesRecord
                                    .sistole
                                    .toString(),
                                diastole: floatingActionButtonTelkesRecord
                                    .diastole
                                    .toString(),
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return CircularPercentIndicator(
                                        percent: valueOrDefault<double>(
                                          functions.sistoleCopy(
                                              progressBarTelkesRecord.sistole),
                                          0.0,
                                        ),
                                        radius: 110.0,
                                        lineWidth: 20.0,
                                        ...
                                        center: Text(
                                          valueOrDefault<String>(
                                            '${valueOrDefault<String>(
                                              ...
                                              progressBarTelkesRecord.diastole
                                                  .toString(),
                                              '0',
                                            )} mmHg',
                                            'mmHg',
