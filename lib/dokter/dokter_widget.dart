...
class _DokterWidgetState extends State<DokterWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DokterModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TelkesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TelkesRecord> dokterTelkesRecordList = snapshot.data!;
        final dokterTelkesRecord = dokterTelkesRecordList.isNotEmpty
            ? dokterTelkesRecordList.first
            : null;
                        ...
                        builder: (context, snapshot) {
                          ...
                          return InkWell(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: listViewTelkesRecordList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewTelkesRecord =
                                    listViewTelkesRecordList[listViewIndex];
                                return Padding(
