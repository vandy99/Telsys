  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TelkesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TelkesRecord> settingTelkesRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final settingTelkesRecord = settingTelkesRecordList.isNotEmpty
            ? settingTelkesRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          settingTelkesRecord!.displayName,
                          style:
