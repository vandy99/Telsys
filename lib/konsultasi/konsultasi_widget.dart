...
class KonsultasiWidget extends StatefulWidget {
  const KonsultasiWidget({super.key});
        ...
        body: SafeArea(
          ...
          child: Align(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 75.0, 0.0, 75.0),
                  child: Text(
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 25.0, 0.0, 75.0),
                  child: Text(
                    'Klik untuk melanjutkan',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Readex Pro',
                          color: const Color(0xFF929CA1),
                        ),
                  ),
                ),
              ],
