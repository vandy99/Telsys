                      ...
                      ...mapToFirestore(
                        {
                          'List': FieldValue.arrayUnion([
                            getListsuhuFirestoreData(
                              createListsuhuStruct(
                                date: dateTimeFormat(
                                    'd/M/y', getCurrentTimestamp),
                                suhu: floatingActionButtonTelkesRecord.suhu
                                    .toString(),
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return CircularPercentIndicator(
                                    percent: valueOrDefault<double>(
                                      functions.suhu(valueOrDefault<double>(
                                        progressBarTelkesRecord.suhu.toDouble(),
                                        0.0,
                                      )),
                                      0.0,
                                    ),
