...
class Backward3Widget extends StatefulWidget {
  const Backward3Widget({Key? key}) : super(key: key);
                            ...
                            Text(
                              valueOrDefault<String>(
                                'Kemungkinan anda mengidap penyakit ${FFAppState().Backward} dengan tingkat kemungkinan ${() {
                                  if ((FFAppState().Backward1 == 'Ya') &&
                                      (FFAppState().Backward2 == 'Tidak')) {
                                    return () {
                                      if ((FFAppState().Backward3 == 'Ya') &&
                                          (FFAppState().Backward6 == 'Tidak')) {
                                        return '66,67 %';
                                      } else if ((FFAppState().Backward3 ==
                                              'Tidak') &&
                                          (FFAppState().Backward6 == 'Ya')) {
                                        return '66,67 %';
                                      } else if ((FFAppState().Backward3 ==
                                              'Ya') &&
                                          (FFAppState().Backward6 == 'Ya')) {
                                  ...
                                  } else if ((FFAppState().Backward1 ==
                                          'Tidak') &&
                                      (FFAppState().Backward2 == 'Ya')) {
                                    return () {
                                      if ((FFAppState().Backward4 == 'Ya') &&
                                          (FFAppState().Backward5 == 'Tidak')) {
                                        return '66,67 %';
                                      } else if ((FFAppState().Backward4 ==
                                              'Tidak') &&
                                          (FFAppState().Backward5 == 'Ya')) {
                                        return '66,67 %';
                                      } else if ((FFAppState().Backward4 ==
                                              'Ya') &&
                                          (FFAppState().Backward5 == 'Ya')) {
