...
class _AkunWidgetState extends State<AkunWidget> {
  ...
  void initState() {
    ...
    _model.umurFocusNode ??= FocusNode();

    _model.beratbadanFocusNode ??= FocusNode();
              ...
              child: StreamBuilder<List<TelkesRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return TextFormField(
                    controller: _model.namaController ??= TextEditingController(
                      text: namaTelkesRecord?.displayName,
                    ),
                    ...
                    validator:
                        _model.namaControllerValidator.asValidator(context),
                  );
                },
              ),
            ),
              ...
              child: StreamBuilder<List<TelkesRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final umurTelkesRecord = umurTelkesRecordList.isNotEmpty
                      ...
                      : null;
                  return TextFormField(
                    controller: _model.umurController ??= TextEditingController(
                      text: umurTelkesRecord?.umur.toString(),
                    ),
                    focusNode: _model.umurFocusNode,
                    textCapitalization: TextCapitalization.words,
                    obscureText: false,
                    decoration: InputDecoration(
                      labelText: 'Umur',
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator:
                        _model.umurControllerValidator.asValidator(context),
                  );
                },
              ),
            ),
                  ...
                  return FlutterFlowDropDown<String>(
                    controller: _model.dropDownValueController ??=
                      ...
                      _model.dropDownValue ??=
                          dropDownTelkesRecord?.jenisKelamin,
                    ),
                ...
                builder: (context, snapshot) {
                  ...
                  final beratbadanTelkesRecord =
                      beratbadanTelkesRecordList.isNotEmpty
                          ...
                          : null;
                  return TextFormField(
                    controller: _model.beratbadanController ??=
                        TextEditingController(
                      text: beratbadanTelkesRecord?.berat.toString(),
                    ),
                    focusNode: _model.beratbadanFocusNode,
                    textCapitalization: TextCapitalization.words,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator: _model.beratbadanControllerValidator
                        .asValidator(context),
                  );
                },
              ),
              ...
              child: Padding(
                ...
                child: StreamBuilder<List<TelkesRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<TelkesRecord> buttonTelkesRecordList = snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final buttonTelkesRecord = buttonTelkesRecordList.isNotEmpty
                        ? buttonTelkesRecordList.first
                        : null;
                    return FFButtonWidget(
                      onPressed: () async {
                        await buttonTelkesRecord!.reference
                            .update(createTelkesRecordData(
                          umur: int.tryParse(_model.umurController.text),
                          jenisKelamin: _model.dropDownValue,
                          berat: int.tryParse(_model.beratbadanController.text),
